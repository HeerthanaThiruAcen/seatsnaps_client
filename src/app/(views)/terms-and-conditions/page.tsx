...
export default function Page() {
  return (
    <div className="container">
      ...
      <h3
        className={`${dmSans.className} font-bold text-xl text-gray-900 mb-4`}
      >
        Interpretation
      </h3>
      <p className="mb-6">
      ...
      <h3
        className={`${dmSans.className} font-bold text-lg text-gray-900 mb-4`}
      >
        Definitions
      </h3>
      <p className="mb-6">For the purposes of these Terms and Conditions:</p>
      <ul className="list-disc pl-5 mb-6">
        ...
        <li className="mb-2">
          <p>
            ...
            "Us" or "Our" in this Agreement) refers to Seat Snaps, Jaffna.`}
          </p>
        </li>
        <li className="mb-2">
          <p>
        ...
        <li className="mb-2">
          <p>
            <strong>Website</strong> refers to Seat Snaps, accessible from{" "}
            <a
      ...
      <h3
        className={`${dmSans.className} font-bold text-lg text-gray-900 mb-2`}
      >
        Severability
      </h3>
      <p className="mb-6">
